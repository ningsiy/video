...
Page({
  ...
  data: {
    ...
    videoId: "",
    src: "",
    imagesrc: "https://thirdwx.qlogo.cn/mmopen/vi_32/K8Ky3va8FGic29r977lu1RBSLlqVTwe1tGNOoK6HmHBMiayA5XLj1qWicPSU5salpdnmQZwjJ2LjlhIh1Kqibsct3Q/132",
    videoInfo: {},
    userLikeVideo: false,
    placeholder: "说点什么吧...",
    CommentList: [{
      createTime: '2022-07-01 18:00:00',
      nickName: 'acb',
      comment: '不错不错'
    },
    {
      createTime: '2022-07-02 18:00:00',
      nickName: 'bbc',
      comment: '厉害厉害'
    }],
    contentValue: "",
  ...
  sendComment: function (e) {
    ...
    var createTime =this.GetCurrentTimeStr()

    var cl = this.data.CommentList
  ...
  onShareAppMessage: function (res) {
    ...
    return {
      title: '快来看看我发布的视频吧',
      path: '/index/videoInfo?video_src=' + videoInfo.videoPath
